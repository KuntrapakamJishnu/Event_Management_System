...
const EventRegistrationForm = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (props.action === "create"){
      Axios.post("https://event-management-system-f7wg-api.vercel.app/eventRoute/create-event", formData)
      .then((res) => {
        if(res.status === 200)
        {
      ...
      // console.log(formData);
        ...
        Axios.all([
            Axios.put("https://event-management-system-f7wg-api.vercel.app/eventRoute/update-event/" + props.id, eventData)
                .then((updateResponce) => {
